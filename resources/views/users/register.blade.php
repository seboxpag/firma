...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Rejestracja nowego użytkownika') }}</div>
                    ...
                    <form method="POST" action="/users/reg">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                              ...
                              <input id="stanowisko" type="number" class="form-control @error('stanowisko') is-invalid @enderror" name="stanowisko" value="{{ old('stanowisko') }}" required autocomplete="stanowisko" autofocus>
