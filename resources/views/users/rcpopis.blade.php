    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                  @can('isBoss')
                    <form method="POST" action="/users/opis">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select id="name" type="number" class="form-control @error('pracownik') is-invalid @enderror" name="pracownik" value="{{ old('name') }}" autofocus>
